...
- **Authors:** Francesco Dente; Andy Combey; Alix Lhéritier; Rodrigo Acuna-Agost; E. Diego Mercerat
- **Venue:** ECML PKDD 2025 (Applied Data Science Track)
- **Year:** 2026
- **Link:** [Conference Proceedings](https://link.springer.com/conference/ecmlpkdd)
...
- Development of predictive models for natural frequency variations based on environmental parameters
- Novel combination of deep temporal convolutional features with Bai-Perron test for structural break detection
- Assessment methodology for post-seismic recovery time to detect potential structural damage
- Application to UNESCO World Heritage site demonstrating practical utility for heritage conservation

## Citation

{% raw %}
```bibtex
@inproceedings{dente2026preserving,
  title={Preserving the World Heritage: Post-Earthquake Monitoring Based on Structural Break Testing with Deep Temporal Convolutional Features},
  author={Dente, Francesco and Combey, Andy and Lh\'eritier, Alix and Acuna-Agost, Rodrigo and Mercerat, E. Diego},
