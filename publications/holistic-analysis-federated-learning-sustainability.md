---
layout: default
title: "Holistic analysis on the sustainability of Federated Learning lifecycle in real-world industrial settings"
year: 2025
---
...
- **Year:** 2025
- **Link:** [arXiv](https://arxiv.org/abs/2312.14628)
...
- Novel framework for analysis of energy and carbon footprints of Cross-Silo FL across the AI product life cycle
- Real-world FL environments: reporting and analyzing cost and carbon footprint in multiple industrial scenarios
- Novel system based on Cross-Silo Federated Learning and Federated Analytics to improve sustainability and minimize redundancy

## Citation

{% raw %}
```bibtex
@article{cao2025holistic,
  title={Holistic analysis on the sustainability of Federated Learning lifecycle in real-world industrial settings},
  author={Cao, Hongliu},
  journal={arXiv preprint arXiv:2312.14628},
  year={2025}
}
```
{% endraw %}
